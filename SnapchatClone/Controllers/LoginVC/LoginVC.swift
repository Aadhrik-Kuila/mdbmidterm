...
class LoginVC: UIViewController {
    ...
    func handleLogin() {
        ...
        if email == "" {
            self.displayAlert(title: "No Email", message: "Please enter an email")
        }
        if password == "" {
            self.displayAlert(title: "No Password", message: "Please enter a password")
        }
        /* PART 1A FINISH*/
    ...
    func handleRegister() {
        ...
        password = passwordTextField.text!
        if name == "" {
            self.displayAlert(title: "No Name", message: "Please enter a name")
        }
        if number == "" {
            self.displayAlert(title: "No Number", message: "Please enter a phone number")
        }
        if email == "" {
            self.displayAlert(title: "No Email", message: "Please enter an email")
        }
